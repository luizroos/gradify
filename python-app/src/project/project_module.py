...
class ProjectModule:
    ...
    def get_module_path(self, base_dir: str) -> str:
    ...
    def directory_exists(self, base_dir: str) -> bool:
        return os.path.isdir(self.get_module_path(base_dir))
    ...
    def create_module_directories(self, base_dir: str, relative_dirs: List[str]):
        for relative_dir in relative_dirs:
            full_path = os.path.join(self.get_module_path(base_dir), relative_dir)
